...
const endColumns = [
  ...
  { id: 'maxFaceWidth', label: '最大面振り幅', width: 120 },
  ...
  { id: 'topOverhang', label: 'はね出し寸法(上)', width: 120 },
  { id: 'bottomOverhang', label: 'はね出し寸法(下)', width: 120 },
  { id: 'furringThickness', label: '胴縁の厚み', width: 120 },
  { id: 'maxFurringPitch', label: '最大胴縁ピッチ', width: 120 },
  { id: 'embrace11v', label: '抱き(11V)', width: 120 },
  { id: 'aluminumPitch', label: 'アルミ枠ピッチ', width: 120 },
  { id: 'topDistance', label: '板〜柱トップ', width: 120 },
] as const;
